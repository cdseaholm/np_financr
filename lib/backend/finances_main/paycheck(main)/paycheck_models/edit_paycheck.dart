...
class EditpaycheckModel extends ConsumerStatefulWidget {
  final PaycheckModel paycheckToUpdate;
  final Function(PaycheckModel) onpaycheckUpdated;
  const EditpaycheckModel(
      {Key? key,
      required this.paycheckToUpdate,
      required this.onpaycheckUpdated})
      : super(key: key);

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _EditpaycheckModelState();
}

@override
class _EditpaycheckModelState extends ConsumerState<EditpaycheckModel> {
  ...
  void initState() {
    super.initState();
    var paycheckToUpdate = widget.paycheckToUpdate;

    titleController = TextEditingController(
      text: paycheckToUpdate.paycheckTitle,
    );
    descriptionController = TextEditingController(
      text: paycheckToUpdate.description,
    );
    moneyController =
        TextEditingController(text: paycheckToUpdate.amount.toString());
  }
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  if (userID != null) {
                    try {
                      ref
                          ...
                          .removepaycheck(paycheckToUpdate);
                    } catch (error) {
                      if (kDebugMode) {
                        print('Error deleting paycheck: $error');
                      }
                    }
                  }
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          DateTimeWidget(
            titleText: 'Date',
            valueText: paycheckToUpdate.datepaycheck,
              ...
              child: Builder(builder: (context) {
                return ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    final updatedpaycheck = await ref
                        .read(updatepaycheckProvider)
                        .updatepaycheckFields(
                          userID: userID!,
                          paycheckID: paycheckToUpdate.docID,
                          newTitle: newTitle,
                          newDescription: newDescription,
                          newDate: paycheckToUpdate.datepaycheck,
                          newAmount: paycheckToUpdate.amount,
                        );

                    if (updatedpaycheck != null) {
                      ToDoService().updatepaychecksList(ref, updatedpaycheck);
                    }
