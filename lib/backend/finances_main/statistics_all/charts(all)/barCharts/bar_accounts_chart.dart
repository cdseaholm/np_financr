...
class BarAccountsChartWidget extends StatefulHookConsumerWidget {
  const BarAccountsChartWidget({required this.selected, super.key});
...
class _BarChartWidgetState extends ConsumerState<BarAccountsChartWidget> {
