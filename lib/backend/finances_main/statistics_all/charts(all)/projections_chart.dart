...
class ProjectionsChartWidget extends StatefulHookConsumerWidget {
  const ProjectionsChartWidget({required this.selected, super.key});

  final String selected;

  @override
  ConsumerState<ConsumerStatefulWidget> createState() =>
      _ProjectionsChartWidgetState();
}

class _ProjectionsChartWidgetState
    extends ConsumerState<ProjectionsChartWidget> {
